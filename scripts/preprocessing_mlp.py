...
def preprocessing_mlp(pandas_row):
    ...
    return {"mut": name_mut, "d_mat_wt_mean": d_mat_wt_mean, "d_mat_wt_std": d_mat_wt_std, "u_lj_wt_mean": u_lj_wt_mean,
            "u_lj_wt_std": u_lj_wt_std, "u_el_wt_mean": u_el_wt_mean,  "u_el_wt_std": u_el_wt_std,
            "d_mat_mut_mean": d_mat_mut_mean, "d_mat_mut_std": d_mat_mut_std, "u_lj_mut_mean": u_lj_mut_mean,
            "u_lj_mut_std": u_lj_mut_std, "u_el_mut_mean": u_el_mut_mean,  "u_el_mut_std": u_el_mut_std, "temp": temp,
            "DDG": DDG}
